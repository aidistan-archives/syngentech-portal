...
en:
  ...
  _1:
    ...
    _:
      - h: "Design and Construction of Genetic Circuits"
        p: "Progress of synthetic biology has provided life science research genetic parts with excellent performance. Using modular genetic parts such as promoters, terminators, enhancers, and resistance genes, we can accomplish gene silencing and gene editing more precisely and efficiently in vivo."
        _:
          - h: Gene Silencing
            a: "/service/solution/silencing/"
            _:
              - h: miRNA sponge
                a: "/service/product/miRNA-sponge-design/"
              - h: shRNA
                a: "/service/product/RNAi-design/"
              - h: Transcriptional Inhibition
                a:
          - h: Gene Editing
            a: "/service/solution/"
            _:
              - h: CRISPR/Cas
                a: "/service/product/CRISPR-design/"
              - h: gRNA Library
                a: "/service/product/gRNA-library/"
              - h: Base Editor
                a: "/service/BE4/"
          - h: Gene Over-expression
            a: "/service/product/gene-synthesis/"
            _:
              - h: Heterologous Gene Expression
                a: ""
      ...
      - h: "Virus Packaging"
        ...
        _:
          ...
          - h: Adenovirus
            a: "/service/product/adenovirus/"
          - h: Adeno-associated Virus
            a: "/service/adeno-associated-virus/"
      - h: "Gene Function Analysis"
        p: "Gene functional analysis is critical for life science. Variations of cellular metabolism are abundantly characterized. Precise detection of these indicators facilitates accurate evaluation of biological function of genes and explores the pathway mechanisms of cellular phenotype."
        _:
          - h: Construction of Cell Line
            a: "/service/solution/knock-down/"
          - h: Cell Colonies Assay
            a: "/service/MSS/"
          - h: Cell Proliferation Assay
            a: "/service/MSS/"
          - h: Cell Apoptosis Assay
            a: "/service/MSS/"
          - h: Cell Cycle Assay
            a: "/service/MSS/"
          - h: Cell Migration Assay
            a: "/service/MSS/"
          - h: Cell Invasion Assay
            a: "/service/MSS/"
...
zh:
  ...
  _1:
    ...
    _:
      - h: "基因元件组装设计及规划"
        p: "合成生物学的进步和发展为生命科学研究提供了性能优异的基因元件。借助如启动子、终止子、增强子、抗性基因等模块化的基因元件，我们可以在生物体内精准便捷地实现基因沉默、基因编辑等调控。"
        _:
          - h: 基因沉默
            a: "/service/solution/silencing/"
            _:
      ...
      - h: "病毒载体包装"
        ...
        _:
          ...
          - h: 腺相关病毒
            a: "/service/adeno-associated-virus/"
      - h: "基因功能分析验证"
        p: "基因功能分析验证对于生命科学极其重要。细胞代谢具有丰富的表征形式，精准检测这些指标有利于准确评估基因的生物学功能并探究细胞表型改变的内在通路机制。"
        _:
          - h: 细胞稳转株构建
            a: "/service/solution/knock-down/"
          - h: 细胞克隆形成能力检测
      ...
      <div v-for="(x, i) in $t('_1._')" :key="i">
        ...
        <el-row>
          <el-col v-for="(y, i) in x._" :key="i" :xs="24" :sm="12" :md="8">
            <el-card>
              <div class="title">
                <el-link :disabled="y.a === ''" :href="y.a">{{ y.h }}</el-link>
              </div>
              <template v-if="y._">
                <div v-for="(z, i) in y._" :key="i">
                  <el-link :disabled="z.a === ''" :href="z.a">{{ z.h ? '- ' + z.h : '' }}</el-link>
                </div>
              </template>
            </el-card>
          </el-col>
